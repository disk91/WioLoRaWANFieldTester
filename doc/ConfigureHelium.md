...
Then, enter a **Name** and Search the **Label** you created previously to make the attachement. You need to click on the Label name once displayed to add it in the form field. Then Save.
